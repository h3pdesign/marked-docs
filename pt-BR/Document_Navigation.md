...
![][8]
   ...
   [8]: images/tableofcontentsbutton.jpg @2x width=740px height=238px class=centro
...
![Alternar tela cheia][12]
   ...
   [12]: images/tableofcontentsfullscreentoggle.jpg @2x width=740px height=238px class=centro
