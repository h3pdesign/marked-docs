...
![][1]
   ...
   [1]: images/multifiledocumentstructure.jpg @2x width=316px height=163px class=centro
...
![Limites de arquivo incluídos][2]
   ...
   [2]: images/includeboundaries.png @2x width=859px height=239px class=centro
