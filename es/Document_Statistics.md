...
![][1]
   ...
   [1]: imágenes/WordCount.jpg @2x width=840px height=61px clase=centro
...
![Ventana emergente de recuento de palabras al seleccionar texto][2]
   ...
   [2]: imágenes/wordcountforselection.jpg @2x width=749px height=144px clase=centro
...
![Barra de estadísticas de legibilidad][3]
   ...
   [3]: imágenes/capturas de pantalla/mainwindow-feature-stats-lower-crop.jpg @2x width=1089px height=111px clase=centro
