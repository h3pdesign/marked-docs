...
![][8]
   ...
   [8]: imágenes/tableofcontentsbutton.jpg @2x width=740px height=238px clase=centro
...
![Alternar pantalla completa][12]
   ...
   [12]: imágenes/tableofcontentsfullscreentoggle.jpg @2x width=740px height=238px clase=centro
