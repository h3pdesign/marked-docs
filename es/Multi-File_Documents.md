...
![][1]
   ...
   [1]: imágenes/multifiledocumentstructure.jpg @2x width=316px height=163px clase=centro
...
![Límites de archivos incluidos][2]
   ...
   [2]: imágenes/includeboundaries.png @2x width=859px height=239px clase=centro
