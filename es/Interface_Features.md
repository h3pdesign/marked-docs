...
![][4]
   ...
   [4]: imágenes/gearmenu.jpg @2x width=740px height=235px clase=centro
...
![][5]
   ...
   [5]: imágenes/KeepOnTopPin.jpg @2x width=740px height=345px clase=centro
...
![][6]
   ...
   [6]: imágenes/view_source.jpg @2x width=740px height=345px clase=centro
...
![][7]
   ...
   [7]: imágenes/SearchBarFull.jpg @2x width=818px height=195px clase=centro
...
![][11]
   ...
   [11]: imágenes/markdown_reference.jpg @2x width=1148px height=267px clase=centro
