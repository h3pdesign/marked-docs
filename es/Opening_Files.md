...
![][2]
   ...
   [2]: imágenes/file_open.jpg @2x width=300px height=118px clase=centro
...
![][3]
   ...
   [3]: imágenes/open_recent.jpg @2x width=300px height=174px clase=centro
...
## Nueva vista en el archivo actual [multivista]
