...
![][1]
   ...
   [1]: imágenes/validate_single.png @2x width=832px height=267px clase=centro
...
![][2]
   ...
   [2]: imágenes/capturas de pantalla/mainwindow-feature-urlvalidate-crop.jpg @2x width=1089px height=300px clase=centro
