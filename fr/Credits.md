...
| [GHMarkdownParser](Discount_License.html) | [Olivier Letterer](https://github.com/OliverLetterer) | MIT | Wrapper Objective-C autour de Remise |
| [cmark-gfm](CommonMark_License.html) | [John MacFarlane](https://github.com/jgm) et contributeurs | BSD-2-Clause | Analyse Markdown aromatisée GitHub |
...
| [CacaoBûcheron](https://github.com/CocoaLumberjack/CocoaLumberjack) | Deusty, LLC | BSD-3-Clause | Debug logging |
...
| [RNTextStatistiques](https://github.com/rnystrom/RNTextStatistics) | Ryan Nystrom | MIT | Lisibilité et statistiques de texte |
...
| [IAPManager](https://github.com/mruegenberg/IAPManager) | Marcel Ruegenberg | See project | Aides aux achats intégrés (ancienne version) |
...
| [Highlight.js](https://highlightjs.org/) | Josh Goebel et contributeurs | BSD-3-Clause | Syntax highlighting |
...
| [Yepnope](https://github.com/SlexAxton/yepnope) | Alex Sexton et Paul irlandais | MIT/WTFPL | Chargement du script (via la version Modernizr) |
...
| [jwerty](https://github.com/keithamus/jwerty) | Keith Cirkel; Ben Alman (accélérateur/anti-rebond) | MIT | Keyboard shortcuts |
