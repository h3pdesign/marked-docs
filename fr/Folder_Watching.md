...
Les applications de bloc-notes qui laissent des fichiers individuels sur le disque (bibliothèques classiques de style **nvALT**, **nvUltra**, **Notational Velocity**, dossiers Git synchronisés, dossiers de travail Dropbox, etc.) s'associent naturellement à la surveillance des dossiers : vous écrivez dans une fenêtre et gardez Marqué épinglé à côté sans rouvrir manuellement les aperçus.
