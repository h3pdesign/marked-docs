...
Le menu Gear fournit la plupart des fonctionnalités de la barre de menus, ainsi que certaines fonctions spécifiques à l'aperçu. Cliquez simplement sur l'engrenage en bas à droite de la fenêtre pour accéder à ces fonctions.
...
Dans le {% prefspane General %}, vous pouvez utiliser « Conserver les nouvelles fenêtres en haut » pour définir les nouvelles fenêtres pour qu'elles restent toujours au-dessus des autres fenêtres, et/ou pour que les fenêtres s'élèvent en haut lorsque leur document associé est mis à jour. Windows configuré pour augmenter lors de la mise à jour ne "volera pas le focus" de votre éditeur, ils augmenteront uniquement pour être visibles sans devenir actifs.
...
Dans le {% prefspane General %}, vous pouvez désigner un raccourci clavier personnalisé pour activer Marqué, et un autre pour élever uniquement la fenêtre avant vers le haut sans quitter votre éditeur.