...
MathJax v3 est modulaire. Marqué active toujours les packages TeX/AMS de base, et vous pouvez éventuellement en activer des supplémentaires dans {% prefspane Style %} :
...
![][2]
   ...
   [2] : images/mathjax2.jpg @2x largeur=837px hauteur=260px classe=centre
...
## Numérotation automatique des équations [numérotation]
...
Si vous souhaitez numéroter uniquement les équations AMS, sélectionnez « AMS uniquement » à droite du menu déroulant « latéral ».
