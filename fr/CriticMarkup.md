...
Lorsque CriticMarkup est actif, le nombre de mots et les statistiques du document changent en fonction de la vue dans laquelle vous vous trouvez actuellement. Cela permet de comparer les statistiques de base et le nombre de mots, de phrases et de caractères entre les versions originales et modifiées d'un document.

Pour plus d'informations sur CriticMarkup et l'intégration avec vos éditeurs de texte préférés, consultez la [page d'accueil CriticMarkup](http://criticmarkup.com/).