...
![][1]
   ...
   [1]: images/validate_single.png @2x width=832px height=267px classe=centro
...
![][2]
   ...
   [2]: images/screenshots/mainwindow-feature-urlvalidate-crop.jpg @2x width=1089px height=300px classe=centro
