...
![][1]
   ...
   [1]: images/multifiledocumentstructure.jpg @2x width=316px height=163px classe=centro
...
![Confini dei file inclusi][2]
   ...
   [2]: images/includeboundaries.png @2x width=859px height=239px classe=centro
