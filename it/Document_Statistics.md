...
![][1]
   ...
   [1]: images/WordCount.jpg @2x width=840px height=61px classe=centro
...
![Popup conteggio parole sulla selezione del testo][2]
   ...
   [2]: images/wordcountforselection.jpg @2x width=749px height=144px classe=centro
...
![Barra delle statistiche di leggibilità][3]
   ...
   [3]: images/screenshots/mainwindow-feature-stats-lower-crop.jpg @2x width=1089px height=111px classe=centro
