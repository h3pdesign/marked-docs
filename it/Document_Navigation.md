...
![][8]
   ...
   [8]: images/tableofcontentsbutton.jpg @2x width=740px height=238px classe=centro
...
![Attiva/disattiva schermo intero][12]
   ...
   [12]: images/tableofcontentsfullscreentoggle.jpg @2x width=740px height=238px classe=centro
