...
- **Grundschriftgröße**: Die Grundschriftgröße (normalerweise 16 Pixel)
...
- **Wrapper Padding**: Platz um den Inhaltsbereich
...
- **Body Weight**: Schriftstärke für den Fließtext
...
- **Körperfarbe**: Farbe des Textkörpers
- **Linkfarbe**: Farbe für Links
- **Hervorhebungsfarbe**: Farbe für hervorgehobenen Text (`<em>`)
- **Starke Farbe**: Farbe für starken Text (`<strong>`)
- **Hintergrund markieren**: Hintergrundfarbe für hervorgehobenen Text (`<mark>`)
...
- **Max. Breite**: Maximale Breite für Bilder (z. B. „100 %“, „800 Pixel“)
...
- **Nested Left Margin**: Abstand für verschachtelte Blockzitate (kann „erben“ sein)
...
- **Max. Breite**: Maximale Tischbreite
- **Zellenpolsterung**: Innenabstand
...
- **Randfarbe**: Randfarbe
- **Randradius**: Abgerundete Ecken
- **Wrap-Modus**: Kein Wrap (vor dem Wrap), Konservieren + Wrap (vor dem Wrap) oder Normal (Wrap)
...
- Testen Sie Ihren Stil mit dem **Dark Mode**-Schalter, wenn Sie ihn unterstützen möchten
