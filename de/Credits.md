...
| Komponente | Autoren | Lizenz | Wird für | verwendet
| --- | --- | --- | --- |
| [MultiMarkdown](MultiMarkdown_License.html) | [John Gruber](http://daringfireball.net/), [Fletcher Penney](http://fletcherpenney.net/) | BSD-Stil | Standardprozessor Markdown |
...
| [cmark-gfm](CommonMark_License.html) | [John MacFarlane](https://github.com/jgm) und Mitwirkende | BSD-2-Klausel | GitHub Aromatisiertes Markdown Parsing |
...
| [pdf22md](PDF22MD_License.html) | [Adam Twardoch](https://github.com/twardoch) | MIT | PDF bis Markdown importieren |
...
| [VDKQueue](https://github.com/bdkjones/VDKQueue) | Bryan DK Jones | Custom freizügig | Benachrichtigungen über Dateiänderungen |
...
| [IAPManager](https://github.com/mruegenberg/IAPManager) | Marcel Rügenberg | Siehe Projekt | In-App-Kaufhilfen (alt) |

## Vorschau von JavaScript
...
| [Mermaid](https://mermaid.js.org/) | Meerjungfrau-Mitwirkende | MIT | Diagrammdarstellung |
...
| [jwerty](https://github.com/keithamus/jwerty) | Keith Cirkel; Ben Alman (Gas/Entprellung) | MIT | Tastaturkürzel |
